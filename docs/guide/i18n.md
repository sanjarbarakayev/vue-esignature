...
```ts
import { setLocale, getLocale } from '@sanjarbarakayev/vue-esignature'
...
```ts
import { getErrorMessage } from '@sanjarbarakayev/vue-esignature'
...
```ts
import { detectAndSetBrowserLocale } from '@sanjarbarakayev/vue-esignature'
...
import { VueESignature, setLocale } from '@sanjarbarakayev/vue-esignature'
...
import { setLocale as setESignatureLocale } from '@sanjarbarakayev/vue-esignature'
...
```ts
import { isLocaleSupported, getSupportedLocales } from '@sanjarbarakayev/vue-esignature'
...
```ts
import { i18n } from '@sanjarbarakayev/vue-esignature'
